...
pub fn get_physical_device(
    ...
    use crate::{swapchain, utility};
    for physical_device in physical_devices {
        let indices = utility::get_queue_family_indices(instance, physical_device, surface);
        let extensions_supported =
            utility::are_device_extensions_supported(instance, physical_device, &required_extensions);
